...
class PROCONNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=8, out_channels=32, kernel_size=3, padding=1)  # (64, 64, 8) -> (64, 64, 32)
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, padding=1)  # -> (64, 64, 64)
        self.conv3 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, padding=1)  # -> (64, 64, 128)

        # Batch normalization
        self.batch_norm = nn.BatchNorm2d(64)

        # Max pooling layer
        self.max_pool = nn.MaxPool2d(kernel_size=2, stride=2)  # Reduces size to (32, 32)

        # Fully connected layers
        self.fc1 = nn.Linear(128 * 32 * 32, 1024)  # Input size: 128 channels * 32 * 32
