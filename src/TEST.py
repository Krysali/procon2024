...
def is_inside(x, y, n, m, dtype):
    if dtype == 3: return (x >= 0 and x < m)
    else: return (y >= 0 and y < n)
...
if 1:
    ...
    print(f"Number of unique board states: {tooluur}")
    print(f"Total number of states:{number}")